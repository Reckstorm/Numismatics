...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Numismatics.Models.Log", b =>
                {
                    b.HasOne("Numismatics.Models.Coin", "CoinUpd")
                        .WithMany()
                        .HasForeignKey("CoinUpdID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Numismatics.Models.User", "UserFrom")
                        .WithMany()
                        .HasForeignKey("UserFromID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Numismatics.Models.User", "UserTo")
                        .WithMany()
                        .HasForeignKey("UserToID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CoinUpd");
